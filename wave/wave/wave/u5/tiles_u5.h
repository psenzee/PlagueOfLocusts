...
{
    typedef readable_grid<T> readable_grid_t;
    typedef grid<T>          grid_t;
    ...
    inline static bool is_basic_water(const readable_grid_t &grid, const point2i &p, size_t offset_index = point2i::CENTER)
    {
    ...
    inline static bool is_basic_land(const readable_grid_t &grid, const point2i &p, size_t offset_index = point2i::CENTER)
    {
    ...
    inline static bool is_land(const readable_grid_t &grid, const point2i &p, size_t offset_index = point2i::CENTER)
    {
        return is_land(at_offset(grid, p, offset_index));
    }
    
    inline static bool is_shore(const readable_grid_t &grid, const point2i &p, size_t offset_index = point2i::CENTER)
    {
        return tiles_u5_constants::is_shore(at_offset(grid, p, offset_index));
    }
    
    inline static bool is_river(const readable_grid_t &grid, const point2i &p, size_t offset_index = point2i::CENTER)
    {
        return tiles_u5_constants::is_river(at_offset(grid, p, offset_index));
    }
    
    inline static bool is_any_cardinal_neighbor_shore(const readable_grid_t &grid, const point2i &p)
    {
        return is_shore(grid, p, point2i::NORTH) || is_shore(grid, p, point2i::SOUTH)
        || is_shore(grid, p, point2i::EAST) || is_shore(grid, p, point2i::WEST);
    }
    
    inline static bool is_any_ordinal_neighbor_shore(const readable_grid_t &grid, const point2i &p)
    {
        return is_shore(grid, p, point2i::NORTHEAST) || is_shore(grid, p, point2i::NORTHWEST)
        || is_shore(grid, p, point2i::SOUTHEAST) || is_shore(grid, p, point2i::SOUTHWEST);
    }
    
    inline static bool is_any_neighbor_shore(const readable_grid_t &grid, const point2i &p)
    {
        return is_any_cardinal_neighbor_shore(grid, p) || is_any_ordinal_neighbor_shore(grid, p);
    }
    
    inline static bool is_north_shore(const readable_grid_t &grid, const point2i &p)
    {
        return is_land(grid, p) && is_basic_water(grid, p, point2i::SOUTH);
    }
    
    inline static bool is_south_shore(const readable_grid_t &grid, const point2i &p)
    {
        return is_land(grid, p) && is_basic_water(grid, p, point2i::NORTH);
    }
    
    inline static bool is_east_shore(const readable_grid_t &grid, const point2i &p)
    {
        return is_land(grid, p) && is_basic_water(grid, p, point2i::WEST);
    }
    
    inline static bool is_west_shore(const readable_grid_t &grid, const point2i &p)
    {
        return is_land(grid, p) && is_basic_water(grid, p, point2i::EAST);
    }
    
    inline static bool is_northeast_shore(const readable_grid_t &grid, const point2i &p)
    {
        return is_north_shore(grid, p) && is_east_shore(grid, p);
    }
    
    inline static bool is_northwest_shore(const readable_grid_t &grid, const point2i &p)
    {
        return is_north_shore(grid, p) && is_west_shore(grid, p);
    }
    
    inline static bool is_southeast_shore(const readable_grid_t &grid, const point2i &p)
    {
        return is_south_shore(grid, p) && is_east_shore(grid, p);
    }
    
    inline static bool is_southwest_shore(const readable_grid_t &grid, const point2i &p)
    {
    ...
    static T get_shore_tile(const readable_grid_t &m, const point2i &p)
    {
        T tile = m.get(p);
...
private:
    ...
    inline static T at_offset(const readable_grid_t &grid, const point2i &p, size_t offset_index)
    {
        return grid.get(p.direction_offset(offset_index));
    }
};
