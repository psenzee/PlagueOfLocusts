...
constexpr point2i  operator+(const point2i &p, const size2u_t &sz) { return point2i(p.x + int(sz[0]), p.y + int(sz[1])); }
constexpr size2u_t operator+(const size2u_t &sz, const point2i &p) { return size2u_t { size_t(std::max(int(sz[0]) + p.x, 0)), size_t(std::max(int(sz[1]) + p.y, 0)) }; }
constexpr point2i  operator-(const point2i &p, const size2u_t &sz) { return point2i(p.x - int(sz[0]), p.y - int(sz[1])); }
constexpr size2u_t operator-(const size2u_t &sz, const point2i &p) { return size2u_t { size_t(std::max(int(sz[0]) - p.x, 0)), size_t(std::max(int(sz[1]) - p.y, 0)) }; }
