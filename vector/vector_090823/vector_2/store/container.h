...
struct container : public fixed_vector::container<M, FloatT, TraitsT>
{
    ...
    inline value_type      distance_sq(const vector_t &find, size_t index)                                 const { return arrays::distance_sq(find, _data[index].data); }
    inline value_type      distance_sq(const dynamic_t &find, size_t index)                                const { return arrays::distance_sq(find, _data[index].data); }
    inline value_type      distance_sq(size_t index_a, size_t index_b)                                     const { return arrays::distance_sq(_data[index_a].data, _data[index_b].data); }
    
    inline value_type      distance_sq_limit(const vector_t &find, size_t index, value_type limit_sq)      const { return arrays::distance_sq_limit(find, _data[index].data, limit_sq); }
    inline value_type      distance_sq_limit(const dynamic_t &find, size_t index, value_type limit_sq)     const { return arrays::distance_sq_limit(find, _data[index].data, limit_sq); }
    inline value_type      distance_sq_limit(size_t index_a, size_t index_b, value_type limit_sq)          const { return arrays::distance_sq_limit(_data[index_a].data, _data[index_b].data, limit_sq); }
