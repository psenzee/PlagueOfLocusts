...
template <typename PairT, typename Comp0, typename Comp1> struct compare_0_1 : public compare_chain< PairT, compare_nth<PairT, 0, Comp0>, compare_nth<PairT, 1, Comp1> > {};
template <typename PairT, typename Comp0, typename Comp1> struct compare_1_0 : public compare_chain< PairT, compare_nth<PairT, 1, Comp0>, compare_nth<PairT, 0, Comp1> > {};
