...
template <typename Pair, typename CA, typename CB> struct pair_compare_first_second : public compare_chain< Pair, compare_nth<Pair, 0, CA>, compare_nth<Pair, 1, CB> > {};
template <typename Pair, typename CA, typename CB> struct pair_compare_second_first : public compare_chain< Pair, compare_nth<Pair, 1, CA>, compare_nth<Pair, 0, CB> > {};
