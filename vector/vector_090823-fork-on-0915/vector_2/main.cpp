...
int main(int argc, const char * argv[])
{
    ...
    symbols::pairable *p = symbols::pair::create(symbols::box<int>::create(17), symbols::pair::create(symbols::box<float>::create(3.14)));
    p->destroy();
    //delete p;
    std::array<float, 6> arr({ 0, 1, 3, 4, 6, 7 });
    p = symbols::copy_list(arr);
    p = symbols::pair::create(symbols::box<const char *>::create("+"), p);
    p = symbols::pair::create(symbols::copy_list(arr), p);
    symbols::print(std::cout << "pairs: ", p);
